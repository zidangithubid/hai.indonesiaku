                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-right">
                                <h3 class="mb-0">Create New Festival</h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col px-5">
                            <form id="form-destination" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="date" id="date" class="form-control" placeholder="Some destination's name" aria-describedby="helpId">
                                </div>
                                <div class="form-group">
